...
SECRET_KEY = 'django-insecure-mc&kpdb5r=&=!3i0xzg8mvjy7e#-#ifw$8-%ud!-&&r@+^^m6!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['GTjoblink.pythonanywhere.com', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'joblink/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'joblink/static'),
]
